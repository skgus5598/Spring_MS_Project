                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="createAcc" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="id"  placeholder="name@example.com" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm" name="passwordChk" type="password" placeholder="Confirm password" />
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="${contextPath }/login">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
